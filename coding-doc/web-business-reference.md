...
1. 業務來源只採用 `reference-doc/` 內容：
   - `reference-doc/meeting_record.md`
   - `reference-doc/predemo_meeting_record.md`
...
| 日期 | 來源 | 新增/修正內容 | 影響文件 |
| --- | --- | --- | --- |
| 2026-03-02 | `reference-doc/meeting_record.md`、`reference-doc/predemo_meeting_record.md` | 建立初版業務背景、需求、資料口徑與術語 | 本文件（初版） |
